...
export const ppfInformation = {
  ...
  copy: 'Invisible, precision-fit film that shields your paint from stone chips, scratches, and road debris.',
  introEnd: 0.15,
  chapters: [
    {
      number: '01',
      label: 'Align',
      heading: 'Measured for every panel.',
      copy: 'Each section is positioned precisely for accurate coverage.',
      start: 0.2,
      end: 0.35,
    },
    {
      number: '02',
      label: 'Form',
      heading: 'Made to follow every curve.',
      copy: 'The film is shaped around contours and body lines for a close, natural fit.',
      start: 0.45,
      end: 0.55,
    },
    {
      number: '03',
      label: 'Seal',
      heading: 'Finished edge to edge.',
      copy: 'Every edge is carefully secured for a clean, lasting installation.',
      start: 0.65,
      end: 0.75,
    },
    {
      number: '04',
      label: 'Protected',
      heading: 'See the paint.\nNot the protection.',
      copy: 'Your finish stays visible while the film takes the impact from everyday driving.',
      start: 0.84,
      end: 1,
    },
  ],
