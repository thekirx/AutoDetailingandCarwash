...
const domains = [
  ...
  [
    ...
    notifications,
    ['birthday-greetings', 'busybee', 'lifecycle-sms', 'notification-broadcast', 'notification-broadcast-kinds', 'notification-settings', 'notification-templates', 'notify-booking', 'notify-ops-form', 'notify-planner', 'notify-pos', 'notify-shift-close', 'push-subscribe', 'send-push'],
  ],
