...
export function BookingPage() {
  ...
  const [form,setForm]=useState({customer_first_name:'',customer_last_name:'',customer_phone:'',vehicle_make:'',vehicle_model:'',scheduled_start:'',service_id:'',branch:''})
  ...
  const submit=async(event)=>{
    ...
    // ponytail: anon may INSERT but cannot SELECT full booking rows — skip representation return
