...
| Operations Lead | Network-wide role (`operations_lead`): planner + POS + queue (TL∪BA), all branches, My Pay, **no attendance clock**. Shared **Roadmap** board (`/operations/roadmap`) with SA / ASA / BA. |
