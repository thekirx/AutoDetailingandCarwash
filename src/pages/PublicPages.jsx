...
export function BranchesPage(){return <PageHero eyebrow="Find Hakum" title={<>Two branches.<br/><i>One standard.</i></>} copy="Premium care in Bacoor and Batangas, with comfortable customer spaces and teams who take pride in the details."><section className="content-section branch-section"><div className="public-shell branch-grid"><Branch city="Bacoor" address="RFC Mall, Bacoor, 4102 Cavite"/><Branch city="Batangas" address="Batangas City, 4200 Batangas"/></div></section></PageHero>}
function Branch({city,address}){return <article><div className="branch-map"><MapPin/></div><p className="eyebrow">Hakum Auto Care</p><h2>{city}</h2><p>{address}</p><span><Clock3/> Open daily · Queue varies</span><div><Link className="button button-blue" to="/book">Book this branch</Link><Link className="dark-link" to="/queue">View queue <ArrowRight/></Link></div></article>}
