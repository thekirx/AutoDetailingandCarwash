...
// Legacy /operations/services → inventory hub (default tab); products keep ?tab=merch
assert(
  /path="services"[^>]*Navigate to="\/operations\/inventory/.test(app) ||
    app.includes('to="/operations/inventory"'),
  'services redirect missing',
)
